...
The system displays alerts on the dashboard when temperature readings exceed the threshold configured by an authorized user.
...
| Rabea Thabit | Source control, Flask backend, REST APIs, PostgreSQL |
| Munirah Alotaibi | QA, UI/UX, React frontend, testing, and documentation |

## Conclusion

FlexSight achieved its main objective by delivering a stable sensor-to-dashboard temperature-monitoring MVP with configurable thresholds, dashboard alerts, and role-based access control.
